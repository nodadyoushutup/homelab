...
DEFAULT_APP_TFVARS="${CONFIG_DIR}/terraform/swarm/node_exporter/app.tfvars"
...
usage() {
  cat <<USAGE
Usage: pipelines/terraform/swarm/node_exporter/app.sh [options] [app_tfvars] [backend_config]
