...
DEFAULT_APP_TFVARS="${CONFIG_DIR}/terraform/swarm/cloud-image-repository/app.tfvars"
...
usage() {
  cat <<USAGE
Usage: pipelines/terraform/swarm/cloud-image-repository/app.sh [options] [app_tfvars] [backend_config]
