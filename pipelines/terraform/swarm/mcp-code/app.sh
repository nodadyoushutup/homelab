...
STAGE_NAME="MCP Code aggregate app"
ENTRYPOINT_RELATIVE="pipelines/terraform/swarm/mcp-code/app.sh"
TERRAFORM_DIR="${ROOT_DIR}/terraform/swarm/mcp-code/app"
TFVARS_HOME_DIR="${TFVARS_HOME_DIR:-${CONFIG_DIR:-/mnt/eapp/config}}"
DEFAULT_TFVARS_FILE="${DEFAULT_TFVARS_FILE:-${TFVARS_HOME_DIR}/mcp-code/app.tfvars}"
