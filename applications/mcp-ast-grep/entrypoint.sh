...
DEFAULT_PROJECT_ROOT="${AST_GREP_DEFAULT_PROJECT_ROOT:-/mnt/eapp/code}"
...
WORKSPACE_ROOT_HEADER="${AST_GREP_WORKSPACE_ROOT_HEADER:-x-workspace-root}"
WORKSPACE_ROOT_QUERY_PARAM="${AST_GREP_WORKSPACE_ROOT_QUERY_PARAM:-workspace_root}"
...
export AST_GREP_WORKSPACE_ROOT_HEADER="${WORKSPACE_ROOT_HEADER}"
export AST_GREP_WORKSPACE_ROOT_QUERY_PARAM="${WORKSPACE_ROOT_QUERY_PARAM}"
