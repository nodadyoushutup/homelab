...
export function ThreadView({ interrupt }: ThreadViewProps) {
  ...
  return (
    <div className="app-panel flex h-full w-full flex-col rounded-[1.75rem] border border-border/70 p-8 shadow-2xl shadow-black/10 lg:flex-row">
      {showSidePanel ? (
        <StateView
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      idx === activeInterruptIndex
                        ...
                        : "border-border bg-background/75 text-muted-foreground hover:border-primary hover:text-primary",
                    )}
                  >
                    {title}
                  </button>
