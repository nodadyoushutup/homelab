...
APP_DIR="${LANGCHAIN_AGENT_CHAT_APP_DIR:-${LANGCHAIN_AGENT_CHAT_DEBUG_APP_DIR:-${CHAT_UI_DEBUG_APP_DIR:-${SCRIPT_DIR}/../langchain-agent-chat}}}"
HOST="${LANGCHAIN_AGENT_CHAT_HOST:-${LANGCHAIN_AGENT_CHAT_DEBUG_HOST:-${CHAT_UI_HOST:-${CHAT_UI_DEBUG_HOST:-0.0.0.0}}}}"
PORT="${LANGCHAIN_AGENT_CHAT_PORT:-${LANGCHAIN_AGENT_CHAT_DEBUG_PORT:-${CHAT_UI_PORT:-${CHAT_UI_DEBUG_PORT:-3000}}}}"
PUBLIC_API_URL="${LANGCHAIN_AGENT_CHAT_PUBLIC_API_URL:-${LANGCHAIN_AGENT_CHAT_DEBUG_PUBLIC_API_URL:-${CHAT_UI_PUBLIC_API_URL:-/api}}}"
ASSISTANT_ID="${LANGCHAIN_AGENT_CHAT_ASSISTANT_ID:-${LANGCHAIN_AGENT_CHAT_DEBUG_ASSISTANT_ID:-${CHAT_UI_ASSISTANT_ID:-${CHAT_UI_DEBUG_ASSISTANT_ID:-controller_agent}}}}"
AUTH_SCHEME="${LANGCHAIN_AGENT_CHAT_AUTH_SCHEME:-${LANGCHAIN_AGENT_CHAT_DEBUG_AUTH_SCHEME:-${CHAT_UI_AUTH_SCHEME:-${CHAT_UI_DEBUG_AUTH_SCHEME:-}}}}"
AGENT_SERVER_PORT="${AGENT_SERVER_PORT:-${LANGGRAPH_DEBUG_PORT:-2124}}"
LANGGRAPH_API_URL="${LANGCHAIN_AGENT_CHAT_LANGGRAPH_API_URL:-${LANGCHAIN_AGENT_CHAT_DEBUG_LANGGRAPH_API_URL:-${CHAT_UI_LANGGRAPH_API_URL:-${CHAT_UI_DEBUG_LANGGRAPH_API_URL:-http://127.0.0.1:${AGENT_SERVER_PORT}}}}}"
CLEAR_PORT="${LANGCHAIN_AGENT_CHAT_CLEAR_PORT:-${LANGCHAIN_AGENT_CHAT_DEBUG_CLEAR_PORT:-${CHAT_UI_CLEAR_PORT:-1}}}"
PUBLIC_HOST="${LANGCHAIN_AGENT_CHAT_PUBLIC_HOST:-${LANGCHAIN_AGENT_CHAT_DEBUG_PUBLIC_HOST:-${CHAT_UI_PUBLIC_HOST:-${LANGGRAPH_DEBUG_PUBLIC_HOST:-}}}}"
