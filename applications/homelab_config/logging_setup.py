"""Logging configuration for the homelab-config application."""
...
def configure_colored_logging(level: str = "INFO") -> None:
    ...
    ``coloredlogs`` is imported inside this function so the app can start under
...
__all__ = ["configure_colored_logging", "configure_logging"]
