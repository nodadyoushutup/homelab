...
export function ThreadIdTooltip({ threadId }: { threadId: string }) {
  ...
  return (
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger>
          <p className="rounded-md border border-border/70 bg-muted px-1 py-[2px] font-mono text-[10px] leading-[12px] tracking-tighter text-muted-foreground">
...
export function ThreadIdCopyable({
  ...
  return (
    <TooltipIconButton
      ...
      className="flex w-fit flex-grow-0 cursor-pointer items-center gap-1 rounded-md border p-1 hover:bg-accent/70"
    >
