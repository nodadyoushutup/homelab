...
function ResetButton({ handleReset }: { handleReset: () => void }) {
  return (
    <Button
      onClick={handleReset}
      variant="ghost"
      className="flex items-center justify-center gap-2 text-muted-foreground hover:text-rose-400"
    >
      ...
      {Object.entries(args).map(([key, value]) => {
        ...
        return (
          ...
          >
            ...
            <span className="w-full max-w-full rounded-xl border border-border/70 bg-muted/70 p-3 text-[13px] leading-[18px] text-foreground">
...
function ApproveOnly({
  ...
  return (
    <div className="app-panel flex w-full flex-col items-start gap-4 rounded-2xl border border-border/80 p-6">
...
function EditActionCard({
  ...
  return (
    <div className="app-panel flex w-full min-w-full flex-col items-start gap-4 rounded-2xl border border-border/80 p-6">
...
function RejectActionCard({
  ...
  return (
    <div className="app-panel flex w-full max-w-full flex-col items-start gap-4 rounded-2xl border border-border/80 p-6">
      <div className="flex w-full items-center justify-between">
