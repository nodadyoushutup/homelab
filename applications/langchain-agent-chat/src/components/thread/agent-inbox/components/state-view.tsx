    ...
    <div className="flex w-full flex-col gap-1">
      {messages.map((msg, idx) => {
        ...
        return (
          ...
          >
            <p className="font-medium text-foreground/85">{messageTypeLabel}:</p>
...
function StateViewRecursive(props: StateViewRecursiveProps) {
  ...
  if (props.value == null) {
    return (
      <p className="font-light whitespace-pre-wrap text-muted-foreground">
        null
      </p>
    );
  }
  ...
  return (
    <div
      className={cn(
        ...
        view === "state" &&
          "border-t border-border/70 lg:border-t-[0px] lg:border-l",
      )}
    >
      {view === "description" && (
