    ...
    return (
      ...
      >
        ...
        {removable && (
          <button
            type="button"
            className="bg-background text-muted-foreground hover:bg-accent hover:text-accent-foreground ml-2 self-start rounded-full p-1"
            onClick={onRemove}
  ...
  return (
    ...
    >
      ...
      {removable && (
        <button
          type="button"
          className="bg-background text-muted-foreground hover:bg-accent hover:text-accent-foreground ml-2 rounded-full p-1"
          onClick={onRemove}
