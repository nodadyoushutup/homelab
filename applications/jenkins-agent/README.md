...
| --- | --- | --- |
| ARM64 | `terraform/runners/jenkins-agent-arm64/app` | `.config/terraform/components/arm64.tfvars` |
| AMD64 | `terraform/runners/jenkins-agent-amd64/app` | `.config/terraform/components/amd64.tfvars` |
