...
- The **Code** runtime loads **mcp-code** (filesystem, ast-grep, local git),
  **mcp-rag**, and the **Atlassian** MCP (Jira tools).
...
- `docs/workflows/mcp-code-worktrees-and-multi-agent.md` (parallel lanes)
