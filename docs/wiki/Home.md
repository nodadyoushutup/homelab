...
- [Vault](Vault)
  - [Day-1 operating mode](Vault#day-1-operating-mode)
  - [Local artifact paths](Vault#local-artifact-paths)
  - [Commands](Vault#commands)
  - [Safety and behavior notes](Vault#safety-and-behavior-notes)
- [Grafana](Grafana)
  ...
  - [Bash pipelines](Grafana#bash-pipelines)
    - [App stage (`terraform/docker/grafana/app/pipeline/app.sh`)](Grafana#app-stage-terraformswarmgrafanaapppipelineappsh)
    - [Config stage (`terraform/docker/grafana/config/pipeline/config.sh`)](Grafana#config-stage-terraformswarmgrafanaconfigpipelineconfigsh)
...
- [Prometheus](Prometheus)
  ...
  - [Pipelines](Prometheus#pipelines)
    - [Bash deployment (`terraform/docker/prometheus/app/pipeline/app.sh`)](Prometheus#bash-deployment-terraformswarmprometheusapppipelineappsh)
