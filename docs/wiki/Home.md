...
- [Grafana](Grafana)
  ...
  - [Bash pipelines](Grafana#bash-pipelines)
    - [App stage (`terraform/swarm/grafana/app/pipeline/app.sh`)](Grafana#app-stage-terraformswarmgrafanaapppipelineappsh)
    - [Config stage (`terraform/swarm/grafana/config/pipeline/config.sh`)](Grafana#config-stage-terraformswarmgrafanaconfigpipelineconfigsh)
...
- [Prometheus](Prometheus)
  ...
  - [Pipelines](Prometheus#pipelines)
    - [Bash deployment (`terraform/swarm/prometheus/app/pipeline/app.sh`)](Prometheus#bash-deployment-terraformswarmprometheusapppipelineappsh)
