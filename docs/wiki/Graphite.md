...
./terraform/docker/graphite/app/pipeline/app.sh \
...
1. Open the `graphite` job under the Jenkins root (script path `terraform/docker/graphite/app/pipeline/app.jenkins`).
