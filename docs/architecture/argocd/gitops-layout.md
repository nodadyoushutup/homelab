...
### 2. Terraform root Application — `terraform/components/cluster/argocd/config/`
...
```20:28:terraform/components/cluster/argocd/config/main.tf
    source {
...
| Path | Role |
| --- | --- |
| `terraform/components/cluster/argocd/config/` | Terraform slice — bootstraps root Application only |
