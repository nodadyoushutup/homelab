...
- **`RAG_ALLOWED_PATH_PREFIXES`** — worker ingest allowlist (see `applications/rag-worker/src/rag_worker/pipeline.py`, `_allowed_prefixes`; defaults include **`docs/`** among others).
