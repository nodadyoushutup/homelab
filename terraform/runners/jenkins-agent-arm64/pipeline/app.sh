...
ENTRYPOINT_RELATIVE="terraform/runners/jenkins-agent-arm64/pipeline/app.sh"
TERRAFORM_DIR="${ROOT_DIR}/terraform/runners/jenkins-agent-arm64/app"

JENKINS_AGENT_ARM64_TFVARS_DIR="${JENKINS_AGENT_ARM64_TFVARS_DIR:-${CONFIG_DIR:-${ROOT_DIR}/.config}/terraform/runners/jenkins-agent-arm64}"
