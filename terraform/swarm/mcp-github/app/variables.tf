variable "image_reference" {
  description = "GitHub MCP image to run."
  type        = string
...
variable "env_file_path" {
  description = "Optional dotenv file containing GitHub MCP secrets and settings."
  type        = string
  default     = ""
}
...
variable "published_port" {
  description = "Swarm ingress port exposed for the GitHub MCP HTTP endpoint."
  type        = number
  default     = 18208
}
