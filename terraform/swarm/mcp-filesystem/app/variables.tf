...
variable "image_reference" {
  description = "Filesystem MCP image to run."
  type        = string
  default     = "homelab/mcp-filesystem-homelab:2026.04.16.2"
}
...
variable "published_port" {
  description = "Swarm ingress port exposed for the Filesystem MCP HTTP endpoint."
  type        = number
  default     = 18205
}
