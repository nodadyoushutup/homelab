variable "image_reference" {
  description = "FortiGate MCP image to run."
  type        = string
  default     = "ghcr.io/nodadyoushutup/mcp-fortigate:0.0.1"
}

variable "env_file_path" {
  description = "Optional dotenv file containing FortiGate MCP secrets and settings."
  type        = string
  default     = ""
}
...
variable "published_port" {
  description = "Swarm ingress port exposed for the FortiGate MCP HTTP endpoint."
  type        = number
  default     = 18084
}
