...
data "talos_machine_configuration" "k8s_cp_0" {
  ...
  config_patches     = [for p in var.k8s_cp_0_config_patch_paths : file(p)]
}
...
data "talos_machine_configuration" "k8s_wk_0" {
  ...
  talos_version      = try(var.provider_config.talos.talos_version, null)
  kubernetes_version = try(var.provider_config.talos.kubernetes_version, null)
  config_patches     = [for p in var.k8s_wk_0_config_patch_paths : file(p)]
}
...
data "talos_machine_configuration" "k8s_wk_1" {
  ...
  talos_version      = try(var.provider_config.talos.talos_version, null)
  kubernetes_version = try(var.provider_config.talos.kubernetes_version, null)
  config_patches     = [for p in var.k8s_wk_1_config_patch_paths : file(p)]
}
...
data "talos_machine_configuration" "k8s_wk_2" {
  ...
  talos_version      = try(var.provider_config.talos.talos_version, null)
  kubernetes_version = try(var.provider_config.talos.kubernetes_version, null)
  config_patches     = [for p in var.k8s_wk_2_config_patch_paths : file(p)]
}
...
data "talos_machine_configuration" "k8s_wk_3" {
  ...
  talos_version      = try(var.provider_config.talos.talos_version, null)
  kubernetes_version = try(var.provider_config.talos.kubernetes_version, null)
  config_patches     = [for p in var.k8s_wk_3_config_patch_paths : file(p)]
}
...
data "talos_machine_configuration" "k8s_wk_4" {
  ...
  talos_version      = try(var.provider_config.talos.talos_version, null)
  kubernetes_version = try(var.provider_config.talos.kubernetes_version, null)
  config_patches     = [for p in var.k8s_wk_4_config_patch_paths : file(p)]
}
...
data "talos_machine_configuration" "k8s_wk_5" {
  ...
  talos_version      = try(var.provider_config.talos.talos_version, null)
  kubernetes_version = try(var.provider_config.talos.kubernetes_version, null)
  config_patches     = [for p in var.k8s_wk_5_config_patch_paths : file(p)]
}
...
data "talos_machine_configuration" "k8s_wk_6" {
  ...
  talos_version      = try(var.provider_config.talos.talos_version, null)
  kubernetes_version = try(var.provider_config.talos.kubernetes_version, null)
  config_patches     = [for p in var.k8s_wk_6_config_patch_paths : file(p)]
}
...
data "talos_machine_configuration" "k8s_wk_7" {
  ...
  talos_version      = try(var.provider_config.talos.talos_version, null)
  kubernetes_version = try(var.provider_config.talos.kubernetes_version, null)
  config_patches     = [for p in var.k8s_wk_7_config_patch_paths : file(p)]
}
...
data "talos_machine_configuration" "k8s_wk_8" {
  ...
  talos_version      = try(var.provider_config.talos.talos_version, null)
  kubernetes_version = try(var.provider_config.talos.kubernetes_version, null)
  config_patches     = [for p in var.k8s_wk_8_config_patch_paths : file(p)]
}
...
data "talos_machine_configuration" "k8s_wk_9" {
  ...
  talos_version      = try(var.provider_config.talos.talos_version, null)
  kubernetes_version = try(var.provider_config.talos.kubernetes_version, null)
  config_patches     = [for p in var.k8s_wk_9_config_patch_paths : file(p)]
}
...
data "talos_machine_configuration" "k8s_wk_10" {
  ...
  talos_version      = try(var.provider_config.talos.talos_version, null)
  kubernetes_version = try(var.provider_config.talos.kubernetes_version, null)
  config_patches     = [for p in var.k8s_wk_10_config_patch_paths : file(p)]
}
