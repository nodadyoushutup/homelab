...
ENTRYPOINT_RELATIVE="terraform/docker/prometheus/app/pipeline/app.sh"
TERRAFORM_DIR="${ROOT_DIR}/terraform/docker/prometheus/app"
TFVARS_HOME_DIR="${TFVARS_HOME_DIR:-${TFVARS_DIR:-/mnt/eapp/.tfvars}}"
DEFAULT_TFVARS_FILE="${DEFAULT_TFVARS_FILE:-${TFVARS_HOME_DIR}/prometheus/app.tfvars}"
