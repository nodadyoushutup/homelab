...
ENTRYPOINT_RELATIVE="terraform/docker/jenkins/agent/pipeline/agent.sh"
TERRAFORM_DIR="${ROOT_DIR}/terraform/docker/jenkins/agent"
...
CONTROLLER_TERRAFORM_DIR="${ROOT_DIR}/terraform/docker/jenkins/controller"
