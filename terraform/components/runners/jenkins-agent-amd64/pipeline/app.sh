...
ENTRYPOINT_RELATIVE="terraform/components/runners/jenkins-agent-amd64/pipeline/app.sh"
TERRAFORM_DIR="${ROOT_DIR}/terraform/components/runners/jenkins-agent-amd64/app"

JENKINS_AGENT_AMD64_TFVARS_DIR="${JENKINS_AGENT_AMD64_TFVARS_DIR:-${CONFIG_DIR:-${ROOT_DIR}/.config}/terraform/components/runners/jenkins-agent-amd64}"
