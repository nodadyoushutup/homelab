...
ENTRYPOINT_RELATIVE="terraform/components/runners/gha-runner-arm64/pipeline/app.sh"
TERRAFORM_DIR="${ROOT_DIR}/terraform/components/runners/gha-runner-arm64/app"
