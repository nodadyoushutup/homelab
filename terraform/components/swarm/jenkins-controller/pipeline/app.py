#!/usr/bin/env python3
"""Jenkins controller app — Python port of pipeline/app.sh (run: python3 <path>)."""
...
def build_pipeline() -> SlicePipeline:
    return SlicePipeline(
        name="Jenkins controller app",
        terraform_dir="terraform/components/swarm/jenkins-controller/app",
        tfvars_env="JENKINS_CONTROLLER_APP_TFVARS",
        backend_env="JENKINS_CONTROLLER_APP_BACKEND",
