...
ENTRYPOINT_RELATIVE="terraform/components/swarm/jenkins-controller/pipeline/config.sh"
TERRAFORM_DIR="${ROOT_DIR}/terraform/components/swarm/jenkins-controller/config"

JENKINS_CONTROLLER_TFVARS_DIR="${JENKINS_CONTROLLER_TFVARS_DIR:-${CONFIG_DIR:-${ROOT_DIR}/.config}/terraform/components/swarm/jenkins-controller}"
