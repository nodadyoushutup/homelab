#!/usr/bin/env python3
"""qBittorrent exporter — Python port of pipeline/app.sh (run: python3 <path>)."""
...
def build_pipeline() -> SlicePipeline:
    return SlicePipeline(
        ...
        terraform_dir="terraform/components/swarm/qbittorrent-exporter/app",
        tfvars_env="QBITTORRENT_EXPORTER_APP_TFVARS",
        backend_env="QBITTORRENT_EXPORTER_APP_BACKEND",
