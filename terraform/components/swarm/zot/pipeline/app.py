#!/usr/bin/env python3
"""Zot — Python port of pipeline/app.sh (run: python3 <path>)."""
...
def build_pipeline() -> SlicePipeline:
    return SlicePipeline(
        name="Zot",
        terraform_dir="terraform/components/swarm/zot/app",
        tfvars_env="ZOT_APP_TFVARS",
        backend_env="ZOT_APP_BACKEND",
