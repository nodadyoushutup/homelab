#!/usr/bin/env python3
"""Container housekeeping — Python port of pipeline/app.sh (run: python3 <path>)."""
...
def build_pipeline() -> SlicePipeline:
    return SlicePipeline(
        ...
        terraform_dir="terraform/components/swarm/container-housekeeping/app",
        tfvars_env="CONTAINER_HOUSEKEEPING_APP_TFVARS",
        backend_env="CONTAINER_HOUSEKEEPING_APP_BACKEND",
