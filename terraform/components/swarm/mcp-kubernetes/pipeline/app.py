#!/usr/bin/env python3
"""MCP Kubernetes — Python port of pipeline/app.sh (run: python3 <path>)."""
...
def build_pipeline() -> SlicePipeline:
    return SlicePipeline(
        name="MCP Kubernetes",
        terraform_dir="terraform/components/swarm/mcp-kubernetes/app",
        tfvars_env="MCP_KUBERNETES_APP_TFVARS",
        backend_env="MCP_KUBERNETES_APP_BACKEND",
