#!/usr/bin/env python3
"""Node exporter — Python port of pipeline/app.sh (run: python3 <path>)."""
...
def build_pipeline() -> SlicePipeline:
    return SlicePipeline(
        name="Node exporter",
        terraform_dir="terraform/components/swarm/node_exporter/app",
        tfvars_env="NODE_EXPORTER_APP_TFVARS",
        backend_env="NODE_EXPORTER_APP_BACKEND",
