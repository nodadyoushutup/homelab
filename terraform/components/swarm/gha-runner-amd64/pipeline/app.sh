...
Environment overrides: GHA_RUNNER_AMD64_APP_TFVARS, GHA_RUNNER_AMD64_APP_BACKEND, CONFIG_DIR (from .config/docker/site.env)
USAGE
}
...
run_terraform_init() {
  local init_log
  init_log="$(mktemp -t gha-runner-amd64-app-terraform-init-XXXXXX)"
