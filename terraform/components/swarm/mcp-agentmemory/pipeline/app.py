#!/usr/bin/env python3
"""MCP agentmemory — Python port of pipeline/app.sh (run: python3 <path>)."""
...
def build_pipeline() -> SlicePipeline:
    return SlicePipeline(
        ...
        terraform_dir="terraform/components/swarm/mcp-agentmemory/app",
        tfvars_env="MCP_AGENTMEMORY_APP_TFVARS",
        backend_env="MCP_AGENTMEMORY_APP_BACKEND",
