#!/usr/bin/env python3
"""MCP Google Workspace — Python port of pipeline/app.sh (run: python3 <path>)."""
...
def build_pipeline() -> SlicePipeline:
    return SlicePipeline(
        ...
        terraform_dir="terraform/components/swarm/mcp-google-workspace/app",
        tfvars_env="MCP_GOOGLE_WORKSPACE_APP_TFVARS",
        backend_env="MCP_GOOGLE_WORKSPACE_APP_BACKEND",
