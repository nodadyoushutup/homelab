#!/usr/bin/env python3
"""Graylog app — Python port of pipeline/app.sh (run: python3 <path>)."""
...
def build_pipeline() -> SlicePipeline:
    return SlicePipeline(
        name="Graylog app",
        terraform_dir="terraform/components/swarm/graylog/app",
        tfvars_env="GRAYLOG_APP_TFVARS",
        backend_env="GRAYLOG_APP_BACKEND",
