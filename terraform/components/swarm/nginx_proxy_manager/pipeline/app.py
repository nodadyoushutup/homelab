#!/usr/bin/env python3
"""Nginx Proxy Manager app — Python port of pipeline/app.sh (run: python3 <path>)."""
...
def build_pipeline() -> SlicePipeline:
    return SlicePipeline(
        ...
        terraform_dir="terraform/components/swarm/nginx_proxy_manager/app",
        tfvars_env="NGINX_PROXY_MANAGER_APP_TFVARS",
        backend_env="NGINX_PROXY_MANAGER_APP_BACKEND",
