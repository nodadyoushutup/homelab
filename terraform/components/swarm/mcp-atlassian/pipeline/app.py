#!/usr/bin/env python3
"""MCP Atlassian — Python port of pipeline/app.sh (run: python3 <path>)."""
...
def build_pipeline() -> SlicePipeline:
    return SlicePipeline(
        name="MCP Atlassian",
        terraform_dir="terraform/components/swarm/mcp-atlassian/app",
        tfvars_env="MCP_ATLASSIAN_APP_TFVARS",
        backend_env="MCP_ATLASSIAN_APP_BACKEND",
