#!/usr/bin/env python3
"""MCP GitHub — Python port of pipeline/app.sh (run: python3 <path>)."""
...
def build_pipeline() -> SlicePipeline:
    return SlicePipeline(
        name="MCP GitHub",
        terraform_dir="terraform/components/swarm/mcp-github/app",
        tfvars_env="MCP_GITHUB_APP_TFVARS",
        backend_env="MCP_GITHUB_APP_BACKEND",
