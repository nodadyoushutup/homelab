#!/usr/bin/env python3
"""MCP Playwright — Python port of pipeline/app.sh (run: python3 <path>)."""
...
def build_pipeline() -> SlicePipeline:
    return SlicePipeline(
        name="MCP Playwright",
        terraform_dir="terraform/components/swarm/mcp-playwright/app",
        tfvars_env="MCP_PLAYWRIGHT_APP_TFVARS",
        backend_env="MCP_PLAYWRIGHT_APP_BACKEND",
