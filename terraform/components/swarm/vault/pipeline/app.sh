...
vault_post_deploy_health_check() {
  ...
  env_file="${TFVARS_HOME_DIR:-${CONFIG_DIR:-${ROOT_DIR}/.config}}/terraform/components/swarm/vault/.env"
...
ENTRYPOINT_RELATIVE="terraform/components/swarm/vault/pipeline/app.sh"
