#!/usr/bin/env python3
"""Grafana app — Python port of pipeline/app.sh (run: python3 <path>)."""
...
def build_pipeline() -> SlicePipeline:
    return SlicePipeline(
        name="Grafana app",
        terraform_dir="terraform/components/swarm/grafana/app",
        tfvars_env="GRAFANA_APP_TFVARS",
        backend_env="GRAFANA_APP_BACKEND",
