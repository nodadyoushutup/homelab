#!/usr/bin/env python3
"""Dozzle — Python port of pipeline/app.sh (run: python3 <path>)."""
...
def build_pipeline() -> SlicePipeline:
    return SlicePipeline(
        name="Dozzle",
        terraform_dir="terraform/components/swarm/dozzle/app",
        tfvars_env="DOZZLE_APP_TFVARS",
        backend_env="DOZZLE_APP_BACKEND",
