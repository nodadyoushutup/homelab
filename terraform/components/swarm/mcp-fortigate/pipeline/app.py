#!/usr/bin/env python3
"""MCP FortiGate — Python port of pipeline/app.sh (run: python3 <path>)."""
...
def build_pipeline() -> SlicePipeline:
    return SlicePipeline(
        name="MCP FortiGate",
        terraform_dir="terraform/components/swarm/mcp-fortigate/app",
        tfvars_env="MCP_FORTIGATE_APP_TFVARS",
        backend_env="MCP_FORTIGATE_APP_BACKEND",
