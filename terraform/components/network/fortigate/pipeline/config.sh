...
Environment overrides: FORTIGATE_CONFIG_TFVARS, FORTIGATE_CONFIG_BACKEND, CONFIG_DIR (from .config/docker/site.env)
USAGE
}
...
run_terraform_init() {
  local init_log
  init_log="$(mktemp -t fortigate-config-terraform-init-XXXXXX)"
