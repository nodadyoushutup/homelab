...
class TerraformAgentComponent(ToolCallingAgentComponent):
    display_name: str = "Terraform Agent"
    description: str = (
        "Inspect Terraform stages, modules, providers, variables, and resource wiring with tools, "
    ...
    inputs = [
        ...
        MultilineInput(
            ...
            value=(
                "You are the Terraform agent. Use tools to inspect Terraform stages, providers, resources, modules, "
                "variables, and pipeline wiring. Prioritize confirmed, source-backed findings. Separate facts from "
                "assumptions and risks, stay within the provided Terraform scope, and avoid implementation decisions "
    ...
    async def _get_tools(self) -> list[Tool]:
        ...
        tools = component_toolkit(component=self).get_tools(
            tool_name="call_terraform_agent",
