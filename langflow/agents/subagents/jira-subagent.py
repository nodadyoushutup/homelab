...
class JiraAgentComponent(ToolCallingAgentComponent):
    display_name: str = "Jira Agent"
    description: str = "Handle Jira discovery and operations with tools, including issue creation, edits, comments, transitions, and workflow context."
    ...
    inputs = [
        ...
        MultilineInput(
            ...
            value=(
                "You are the Jira agent. Use tools to handle Jira work end to end: issue discovery, project and "
                "workflow lookup, and live Jira operations such as creating issues, updating fields, adding "
                "comments, and transitioning issues when the request is actionable. Prioritize confirmed, "
                "source-backed results, separate facts from assumptions and risks, stay within the provided Jira "
                "scope, and ask a focused question only when a real Jira blocker remains after tool inspection."
            ),
            advanced=False,
        ),
        MessageTextInput(
