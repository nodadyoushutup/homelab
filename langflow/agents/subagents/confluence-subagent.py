...
class ConfluenceAgentComponent(ToolCallingAgentComponent):
    display_name: str = "Confluence Agent"
    description: str = (
        "Inspect and manage Confluence pages, spaces, attachments, and related "
        "Atlassian data with tools, then return source-backed results."
    )
    ...
    inputs = [
        ...
        MultilineInput(
            ...
            value=(
                "You are the Confluence agent. Use tools to inspect and manage "
                "Confluence pages, spaces, attachments, comments, labels, and "
                "related Atlassian context. Prioritize confirmed, source-backed "
                "findings. If the delegated task is a bounded Confluence action "
                "such as creating a page, updating content, or adding a comment, "
                "perform it when the required inputs are available. Separate "
                "facts from assumptions and risks, stay within the provided "
                "Confluence scope, and keep responses compact and reusable."
            ),
            advanced=False,
        ),
        MessageTextInput(
    ...
    async def _get_tools(self) -> list[Tool]:
        ...
        tools = component_toolkit(component=self).get_tools(
            tool_name="call_confluence_agent",
