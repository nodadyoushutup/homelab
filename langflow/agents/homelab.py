...
class AgentComponent(ToolCallingAgentComponent):
    display_name: str = "Homelab Agent"
    description: str = "Supervise technical work, delegate to the right subagent, and use live tools when appropriate."
    ...
    inputs = [
        ...
        MultilineInput(
            ...
            value=(
                ...
                "Use Jira for Jira discovery and workflow analysis.\n"
                "Use Confluence for page and document analysis.\n"
                "Use Kubernetes for manifest and delivery analysis.\n"
                "Use Pipeline for repo-managed stage pipeline inspection and bounded deployment actions.\n"
                "Use Terraform for stage and infrastructure analysis.\n\n"
                "If the user explicitly asks for a live action through a configured tool, such as creating or updating a Jira issue or Confluence page, prefer the direct tool path when the needed inputs are already available. Do not claim that access or permissions are missing unless a real tool call fails that way or the docs already prove the limitation.\n\n"
                "For delegated analysis, send thin request envelopes instead of full chat history or raw tool output. Respond in normal markdown prose."
            ),
            advanced=False,
        ),
        MessageTextInput(
